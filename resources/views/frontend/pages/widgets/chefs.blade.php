    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                ...
                <div class="chef-member">
                    <div class="member-img">
                        <img src="{{ asset('assets/frontend') }}/img/chefs/chefs-1.jpg" class="img-fluid" alt="">
                        <div class="social">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                ...
                <div class="chef-member">
                    <div class="member-img">
                        <img src="{{ asset('assets/frontend') }}/img/chefs/chefs-2.jpg" class="img-fluid" alt="">
                        <div class="social">
                            <a href=""><i class="bi bi-twitter"></i></a>
                            <a href=""><i class="bi bi-facebook"></i></a>
                            <a href=""><i class="bi bi-instagram"></i></a>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                ...
                <div class="chef-member">
                    <div class="member-img">
                        <img src="{{ asset('assets/frontend') }}/img/chefs/chefs-3.jpg" class="img-fluid" alt="">
                        <div class="social">
                            <a href=""><i class="bi bi-twitter"></i></a>
                            <a href=""><i class="bi bi-facebook"></i></a>
                            <a href=""><i class="bi bi-instagram"></i></a>
