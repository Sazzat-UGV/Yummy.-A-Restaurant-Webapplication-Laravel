...
@section('content')
@include('backend.layout.inc.breadcrumb',['pagename'=>'Image Edit Form'])
        ...
        <div class="card-body mt-2">
           ...
           enctype="multipart/form-data" method="POST">
            ...
            <div class="col-12 mb-3">
                ...
                <input type="file" data-default-file="{{ asset('uploads/gallery') }}/{{ $gallery->image }}" name="image" class=" dropify form-control @error('image')
                is-invalid
                @enderror">
                @error('image')
