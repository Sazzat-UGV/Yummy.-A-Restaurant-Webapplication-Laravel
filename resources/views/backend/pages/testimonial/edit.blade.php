...
@section('content')
@include('backend.layout.inc.breadcrumb',['pagename'=>'Testimonial Edit Form'])
        ...
        <div class="card-body mt-2">
           ...
           enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-3 col-12">
                ...
                <input type="text" name="client_name" value="{{ $testimonial->client_name }}" placeholder="enter client name" class="form-control
                @error('client_name')
                is-invalid
                @enderror">
                @error('client_name')
            ...
            <div class="mb-3 col-12">
                ...
                <input type="text" name="client_designation" value="{{ $testimonial->client_designation }}" placeholder="enter client designation" class="form-control
            ...
            <div class="mb-3 col-12">
                ...
                <input type="number" min="0" value="{{ $testimonial->rating }}" max="5" name="rating" class="form-control
                @error('rating')
                is-invalid
                @enderror">
                @error('rating')
            ...
            <div class=" mb-3 form-check form-switch">
                <input class="form-check-input" type="checkbox" name="is_active" role="switch" id="activeStatus" @if ($testimonial->is_active)
                checked
                @endif
                >
