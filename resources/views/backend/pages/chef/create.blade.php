...
@section('content')
@include('backend.layout.inc.breadcrumb',['pagename'=>'Chef Create Form'])
...
<div class="col-12 mt-5">
    <div class="card">
        <div class="card-body mt-2">
            <form action="{{ route('chef.store') }}"
           enctype="multipart/form-data" method="POST">
            @csrf

            <div class="mb-3 col-12">
                <label for="chef_name" class="form-label">Chef Name  <span class="text-danger">*</span></label>
                <input type="text" name="name" placeholder="enter chef name" class="form-control
                @error('name')
                is-invalid
                @enderror">
                @error('name')
            ...
            <div class="mb-3 col-12">
                ...
                <input type="text" name="position" placeholder="enter chef position" class="form-control
                @error('position')
                is-invalid
                @enderror">
                @error('position')
            ...
            <div class="col-12 mb-3">
                ...
                <input type="file" name="chef_image" class=" dropify form-control @error('chef_image')
                is-invalid
                @enderror">
                @error('chef_image')
